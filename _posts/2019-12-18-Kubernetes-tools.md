...
####Kubectx
Kubectx is a tool to switch between kubernetes contexts. It is written by 'Ahmet Alp Balkan' and he works for Google Cloud as Developer advocate. It is really handy when you are working with multiple clusters at the same time. Kubectx works seamlessly works different shells like Bash, Zsh, fish etc.
